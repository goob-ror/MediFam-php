        ...
        <div class="register-container">
            <div class="register-card">
                <div class="register-image-side">
                    <img src="/public/image/register_illust.png" alt="Register Illustration" class="register-illustration" />
                </div>

                <div class="register-form-side">
                    <div class="login-link-top">
                        <a href="#/login" class="btn-login-account">
                    ...
                    <div class="register-header">
                        ...
                        <p class="register-subtitle">Buat akun untuk mulai berpartisipasi dengan kami</p>
                    </div>
