...
export default function pengaturanBidanView(user) {
  return `
    ${navbarView(user)}

    <div class="dashboard-layout">
        ${sidebarBidanView(user, "pengaturan")}

        <!-- Main Content -->
        <main class="dashboard-main">
            <h1 class="dashboard-title">Pengaturan</h1>

            <div class="settings-container">
                <!-- Account Settings Section -->
                <div class="settings-section">
                    <h2 class="settings-section-title">Pengaturan Akun</h2>
                    <form class="settings-form" id="accountSettingsForm">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="username" 
                                class="form-input" 
                                value="${user.username || user.name || "Bidan"}"
                    ...
                    <div class="notification-settings">
                        <div class="notification-item">
                            <div class="notification-info">
                                <label class="notification-label" for="whatsappNotif">
                                ...
                                <p class="notification-description">Aktifkan untuk menerima pengingat jadwal melalui WhatsApp</p>
                            </div>
